...
public class Ueb18Fassade {
    ...
    public Artikel[] aufgabe_c_i(Lager lager) {
        if (lager == null) throw new IllegalArgumentException("Lager ist Leer");
        lager.getSorted((artikel, artikel2) -> artikel.getArt().compareTo(artikel2.getArt()) <= -1);
        lager.getSorted((artikel, artikel2) -> artikel.getBestand() <= artikel2.getBestand());
        return lager.getSorted((artikel, artikel2) -> artikel.getPreis() <= artikel2.getPreis());
    ...
    public void aufgabe_c_ii(Lager lager) {
        if (lager == null){
            throw new IllegalArgumentException("invaled value");
        }
        Consumer<Artikel> c_ii = a -> {
            a.aenderePreis(-10);
        };
        lager.applyToArticles(c_ii);
    }
    ...
    public void aufgabe_c_iii(Lager lager) {
        ...
        Consumer<Artikel> c_iii = a -> {
            a.setArt(a.getArt() + " Sonderangebot");
        };
        lager.applyToArticles(c_iii);
    }
    ...
    public void aufgabe_c_iv(Lager lager) {
        ...
        Consumer<Artikel> civ = a -> {
            a.aenderePreis(-10);
            a.setArt(a.getArt() + " Sonderangebot");
        };
        lager.applyToArticles(civ);
    }
    ...
    public void aufgabe_h_ii(Lager lager) {
        ...
        Consumer<Artikel> h_iv = a -> {
            if (a.getBestand() <= 2) {
                a.aenderePreis(-5);
            }
        };
        lager.applyToArticles(h_iv);
    }
    ...
    public void aufgabe_h_iii(Lager lager, String gesuchterAutor) {
        if (lager == null || gesuchterAutor == null) {
            throw new IllegalArgumentException("Leere Angaben");
        }
    ...
    public Artikel[] aufgabe_h_v(Lager lager) {
        ...
        return lager.getArticles(a -> a instanceof Buch,
                (artikel, artikel2) -> {
                    Buch a = (Buch) artikel;
                    Buch b = (Buch) artikel2;
                    return a.getAutor().compareTo(b.getAutor()) <= -1;
                });
    }
    ...
    public Artikel[] aufgabe_h_vi(Lager lager, String gesuchterAutor, double minPreis, double maxPreis) {
        if (lager == null || gesuchterAutor == null || minPreis < 0 ||maxPreis < 0 ){
            throw new IllegalArgumentException("invaled value");
        }
        return lager.filterAll(a -> a instanceof Buch, a -> {
                    Buch t = (Buch) a;
                    return t.getAutor().equals(gesuchterAutor);
                },
